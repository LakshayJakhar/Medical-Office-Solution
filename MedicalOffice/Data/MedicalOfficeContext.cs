...
namespace MedicalOffice.Data
{
    public class MedicalOfficeContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //Note: Allow Cascade Delete from Patient to Appointment
            ...
            //For fun we wrote this one the other way around.
        ...
        public DbSet<MedicalOffice.ViewModels.AppointmentSummaryVM> AppointmentSummaryVM { get; set; }
    }
}
